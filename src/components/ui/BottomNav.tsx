          ...
          >
            ...
            {t.id === 'reports' && (
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                ...
                <line x1="7" y1="8" x2="15" y2="8" stroke={active ? '#fff' : 'currentColor'} strokeWidth="1.5" strokeLinecap="round" />
                <line x1="7" y1="11" x2="15" y2="11" stroke={active ? '#fff' : 'currentColor'} strokeWidth="1.5" strokeLinecap="round" />
                <line x1="7" y1="14" x2="12" y2="14" stroke={active ? '#fff' : 'currentColor'} strokeWidth="1.5" strokeLinecap="round" />
              </svg>
            )}
